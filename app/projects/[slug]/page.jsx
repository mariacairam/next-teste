...
export default async function projectPage({ params: { slug } }) {
  ...
  return (
    <>
      <div className="flex relative h-144 col-start-1 col-end-13 mb-12">
        <Image
          src={project.header}
          fill={true}
      ...
      <div className="flex flex-col gap-12 col-start-2 col-end-12">
        ...
        <div className="grid grid-cols-10 col-flow-row gap-1 sm:gap-5">
          <div className="flex flex-col gap-2 col-start-1 col-end-11 xl:col-end-6">
            <div className="flex border-neutral-400 flex-row text-2xl border-y h-14 items-center mt-2 mb-2">
              <p className="text-neutral-400">Credits</p>
            </div>
            <div className="grid grid-cols-5 gap-1 sm:gap-5 col-start-1 xl:col-end-6 items-start 
            overflow-hidden md:h-fit border-b md:border-b-0 border-neutral-500">
        ...
        <div className="flex flex-row gap-5 col-start-2 col-end-12 border-b">
          <div>Images</div>
        </div>
